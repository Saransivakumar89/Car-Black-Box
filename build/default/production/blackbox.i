...
void timeout(void) {
    ...
    GIE = PEIE = TMR0IE = 1;
    clcd_print("  Please Try   ", (0x80 + (0)));
    clcd_print("Again in ", (0xC0 + (0)));
    clcd_putch(seconds / 10 + 48, (0xC0 + (9)));
    clcd_putch(seconds % 10 + 48, (0xC0 + (10)));
...
void view_log() {
    ...
    if (key != 0xFF) {
        ...
        if (pre_key == 6 && shift_pos < index) {
            if (shift_pos < 10)
                shift_pos++;
            clcd_print("                ", (0xC0 + (0)));
        } else if (pre_key == 5 && shift_pos > 0) {
            if (shift_pos > -1)
                shift_pos--;
            clcd_print("                ", (0xC0 + (0)));
        }
    ...
    clcd_putch(shift_pos + '0', (0xC0 + (0)));
    clcd_putch(vlog[0], (0xC0 + (2)));
    clcd_putch(vlog[1], (0xC0 + (3)));
    clcd_putch(vlog[2], (0xC0 + (4)));
    clcd_putch(vlog[3], (0xC0 + (5)));
    clcd_putch(vlog[4], (0xC0 + (6)));
    clcd_putch(vlog[5], (0xC0 + (7)));
    clcd_putch(vlog[6], (0xC0 + (8)));
    clcd_putch(vlog[7], (0xC0 + (9)));
    clcd_putch(vlog[8], (0xC0 + (10)));
    clcd_putch(vlog[10], (0xC0 + (11)));
    clcd_putch(vlog[11], (0xC0 + (12)));
    clcd_putch(vlog[12], (0xC0 + (13)));
    clcd_putch(vlog[14], (0xC0 + (14)));
    clcd_putch(vlog[15], (0xC0 + (15)));
...
void login(unsigned char key) {
    ...
    if (idx < 4) {
        ...
        if (strcmp(password, pass) == 0) {
            ...
            clcd_write(0x01, 0);
            clcd_print("  Login ", (0x80 + (3)));
            clcd_print("Successfull...", (0xC0 + (1)));
            ...
            if (attempts < 3) {
                for (unsigned long int i = 900000; i--;);
                clcd_write(0x01, 0);
                clcd_print("Incorrect  ", (0x80 + (3)));
                clcd_print("Attempts Left:", (0xC0 + (0)));
                clcd_putch('0' + 3 - (attempts), (0xC0 + (15)));
                for (unsigned long int i = 900000; i--;);
                idx = 0;
                clr_pass();
                enter = 0;
...
void menu(unsigned char key) {
    if (arrow_pos == 1) {
        clcd_print("->", (0x80 + (0)));
        clcd_print(main_menu[menu_pos], (0x80 + (3)));
        clcd_print(main_menu[menu_pos + 1], (0xC0 + (3)));
    } else {
        clcd_print("->", (0xC0 + (0)));
        clcd_print(main_menu[menu_pos - 1], (0x80 + (3)));
        clcd_print(main_menu[menu_pos], (0xC0 + (3)));
    }
    ...
    if (key != 0xFF) {
        ...
        if (press_delay == 1000) {
            ...
            if (key == 5) {
                press_delay = 0;
                clcd_putch(menu_pos % 10 + 48, (0x80 + (15)));
        ...
        press_delay = 0;
        m_count++;
        if (pre_key == 6 && menu_pos < 4 && m_count > 1) {
            menu_pos++;
            if (arrow_pos < 2)
                arrow_pos++;
            clcd_write(0x01, 0);
        } else if (pre_key == 5 && menu_pos > 0) {
            menu_pos--;
            if (arrow_pos > 1)
                arrow_pos--;
            clcd_write(0x01, 0);
    ...
    if (l < 4) {
        ...
        if (strcmp(old_pd, pass) == 0) {
            ...
            if (k < 4) {
                ...
                clcd_print("Re_enter  pwd", (0x80 + (0)));
                clcd_putch(' ', (0xC0 + (0)));
                if (key == 5 || key == 6) {
                    clcd_putch('*', (0xC0 + (6 + (k % 4))));
                    return_delay1 = 0;
                    if (key == 5) {
                        new_pd[k++] = '1';
                    } else if (key == 6) {
